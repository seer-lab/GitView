<package_comment name = 'com.tinfoil.sms.crypto.package.comment'>/** 
 ...
 */</package_comment>
<package name = 'com.tinfoil.sms.crypto.package'>
package com.tinfoil.sms.crypto;</package>
...
<class_comment name = 'com.tinfoil.sms.crypto.Encryption.comment'>
/**
 ...
 * Cryptography.
 */<class>
<class name = 'com.tinfoil.sms.crypto.Encryption'>
public class Encryption
{
    <variable name = 'com.tinfoil.sms.crypto.Encryption.encryptMap'>
    private HashMap<Long, ECEngine> encryptMap;
    </variable>
    <variable name = 'com.tinfoil.sms.crypto.Encryption.decryptMap'>
    private HashMap<Long, ECEngine> decryptMap;
    </variable
    
    <variable_comment name = 'com.tinfoil.sms.crypto.Encryption.COUNT_SIZE.comment'>
    /* Size of the message counter in bytes, usually 2 bytes, based on Nonce.MAX_CYCLES */
    </variable name = 'com.tinfoil.sms.crypto.COUNT_SIZE'>
    private static final int COUNT_SIZE = 2;
    </variable>
    
    <method_comment name = 'com.tinfoil.sms.Encryption.crypto.Encryption.comment'>
    /**
     * The basic constructor, initializes the encrypt/decrypt hash maps.
     */
    <method name = 'com.tinfoil.sms.Encryption.crypto.Encryption.method'>
    public Encryption()
    {
        <statement name = 'com.tinfoil.sms.Encryption.crypto.Encryption.statement.1'>
